...
namespace Caelum
{
	...
	const PrecipitationPresetParams PrecipitationPresets[] = {
        { Ogre::ColourValue(0.8f, 0.8f, 0.8f, 1), 0.95f, "precipitation_drizzle.png" },
        { Ogre::ColourValue(0.8f, 0.8f, 0.8f, 1), 0.85f, "precipitation_rain.png" },
        { Ogre::ColourValue(0.8f, 0.8f, 0.8f, 1), 0.12f, "precipitation_snow.png" },
        { Ogre::ColourValue(0.8f, 0.8f, 0.8f, 1), 0.33f, "precipitation_snowgrains.png" },
        { Ogre::ColourValue(0.8f, 0.8f, 0.8f, 1), 0.70f, "precipitation_icecrystals.png" },
        { Ogre::ColourValue(0.8f, 0.8f, 0.8f, 1), 0.78f, "precipitation_icepellets.png" },
        { Ogre::ColourValue(0.8f, 0.8f, 0.8f, 1), 0.74f, "precipitation_hail.png" },
        { Ogre::ColourValue(0.8f, 0.8f, 0.8f, 1), 0.70f, "precipitation_smallhail.png" }
	};
            ...
            Ogre::SceneManager *sceneMgr)
    {
        ...
        setAutoDisableThreshold (0.001f);
            ...
            const Ogre::Vector3& camSpeed) 
    {
		...
		mParams.deltaX.set(mParams.fpParams,
                Ogre::Vector3(sin(appTime) + 4.33f,
                cos(appTime * 1.5f) + 5.26f,
				cos(appTime * 2.5f)) * fallSpeed / 10 + 88.001f);
		mParams.deltaY.set(mParams.fpParams,
                Ogre::Vector3(0.6f, 1.0f, 1.4f) * fallSpeed * appTime);
