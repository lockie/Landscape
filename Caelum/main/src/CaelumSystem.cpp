...
namespace Caelum
{
    ...
    void CaelumSystem::updateSubcomponents (Real timeSinceLastFrame)
    {
        ...
        */
        ...
        Real fogDensity = getFogDensity (float(relDayTime), sunDir);           
        Ogre::ColourValue fogColour = getFogColour (float(relDayTime), sunDir);                  
        Ogre::ColourValue sunLightColour = getSunLightColour (float(relDayTime), sunDir);
        Ogre::ColourValue sunSphereColour = getSunSphereColour (float(relDayTime), sunDir);
        ...
        if (getImageStarfield ()) {
            getImageStarfield ()->update (float(relDayTime));
        ...
        if (getPointStarfield ()) {
            ...
            getPointStarfield ()->_update (float(relDayTime));
        }
